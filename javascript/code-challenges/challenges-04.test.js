...
const updateAnimal = (arr, callback) => {
  let arrUpdateAnimal = new Array();
  arr.forEach(item => arrUpdateAnimal.push(callback(item)))
  return arrUpdateAnimal;
};
...
const sortNumbersByLength = (arr) => {
  return arr.sort((a, b) => a.toString().length < b.toString().length ? -1 : 0)
};
...
const sortPeople = (arr) => {
  return arr.sort((a, b) => a.lastName < b.lastName ? -1 : 0)
};
...
const sortSchedule = (arr) => {
  ...
  let sortedDaysOfWeek = arr.sort((a, b) => {
    return map[a.dayOfWeek] - map[b.dayOfWeek]
  })

  let sortedMeetings = new Array();

  sortedMeetings = sortedDaysOfWeek.sort((a, b) => {
    return a.dayOfWeek === b.dayOfWeek ?
      a.start < b.start ? -1 :
        (a.end - a.start) < (b.end - b.start) ? -1 : 1 : 0
  })
