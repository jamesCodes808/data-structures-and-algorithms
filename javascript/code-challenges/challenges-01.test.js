...
const addOne = (arr) => {
  let addOneArr = new Array();

  arr.forEach(value => addOneArr.push(value + 1));
...
const addExclamation = (arr) => {
  let addExclamationArr = new Array();
...
const allUpperCase = (arr) => {
  let allUpperArr = new Array();

  arr.forEach(string => allUpperArr.push(string.toUpperCase()))
...
const speaker = (words, callback) => {
  let modifiedGreeting = new Array();

  words.forEach(word => modifiedGreeting.push(callback(word)));
