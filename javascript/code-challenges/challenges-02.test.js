...
const raisedToTheThird = (arr) => {
  let arrRaisedToTheThird = new Array();

  arr.forEach(item => {
    arrRaisedToTheThird.push(Math.pow(item, 3));
  });

  return arrRaisedToTheThird;
};
...
const addOne = (arr) => {
  let arrAddOne = arr.map(item => item + 1);
  return arrAddOne;
};
...
const addQuestion = (arr) => {
  let arrAddQuestion = arr.map(item => item + '?');
...
const forLoopTwoToThe = (arr) => {
  let arrTwoToThe = new Array();

  for (let num of arr) {
    arrTwoToThe.push(Math.pow(2, num))
  }
...
const forEachTwoToThe = (arr) => {
  let arrTwoToTheEach = new Array();

  arr.forEach((num) => {
    arrTwoToTheEach.push(Math.pow(2, num))
  });

  return arrTwoToTheEach;
};
...
const mapTwoToThe = (arr) => {
  let arrTwoToTheMap = arr.map(num => Math.pow(2, num));
  return arrTwoToTheMap;
};
...
const charCode = (arr) => {
  let arrCharCode = arr.map(char => char.charCodeAt(0));
  return arrCharCode;
};
...
const extractAbilities = (arr) => {
  let arrExtractedAbilities = arr.map(ability => ability.ability.name);
  return arrExtractedAbilities;
};
...
const extractStats = (arr) => {
  let arrExtractedStats = arr.map(stat => ({ ['name']: stat.stat.name, ['total']: stat.effort + stat.baseStat }))
  return arrExtractedStats;
};
